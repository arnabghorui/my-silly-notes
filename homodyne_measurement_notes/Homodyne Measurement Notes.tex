...
\begin{document}
	...
	\begin{itemize}
		...
		\item Using the above we get, time evolution of quadratures as, $\dot{\xx} = \Omega H \xx$. Solving it we get, $\xx(t) = e^{\Omega H} \xx(0)$.
	...
	\begin{itemize}
		\item Define, $\hat S = e^{\frac{i}{2} \xx^T H \xx}$ and $S = e^{\Omega H}$.
		\item $\hat S_H \xx \hat S_H^\dagger = S_H \xx$.
